    ...
    <div className="space-y-16 sm:space-y-24 pb-12">
      ...
      <section className="text-center pt-6 sm:pt-12 max-w-3xl mx-auto space-y-6">
        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-rose-50 border border-rose-200 text-brand-700 text-xs font-semibold shadow-sm animate-fade-in">
          ...
          <span>WhatsApp-First Matrimonial Platform</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          ...
          >
            <span>Create Your Profile (18+)</span>
            <ArrowRight className="w-4 h-4" />
          </Link>
          <Link
            href="/how-it-works"
            className="w-full sm:w-auto px-6 py-3.5 rounded-xl border border-brand-200 hover:border-brand-300 bg-rose-50/70 hover:bg-rose-100 text-brand-800 font-bold text-sm transition shadow-sm flex items-center justify-center space-x-1.5"
          >
            <Sparkles className="w-4 h-4 text-brand-600" />
            <span>How It Works (User Flow)</span>
          </Link>
          <Link
            href="/discover"
            className="w-full sm:w-auto px-6 py-3.5 rounded-xl border border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold text-sm transition shadow-sm"
          >
            Explore Discover
          </Link>
        </div>
      ...
      <section className="max-w-xl mx-auto">
        <div className="text-center mb-4 flex items-center justify-center space-x-2">
          ...
          <Link href="/how-it-works" className="text-xs text-brand-600 hover:underline font-semibold flex items-center space-x-0.5">
            <span>Learn how info flows</span>
        ...
        <div className="bg-white rounded-3xl p-4 shadow-xl border border-slate-200/80">
          <div className="relative aspect-[16/11] rounded-2xl overflow-hidden bg-slate-100">
            <img
              ...
              alt="Verified Candidate Preview"
            ...
            <div className="absolute bottom-3 left-4 right-4 text-white">
              <div className="font-bold text-lg flex items-center space-x-1.5">
                <span>Priya S., 27</span>
                <span className="text-[10px] bg-emerald-500/80 backdrop-blur px-1.5 py-0.2 rounded font-semibold text-white">Verified</span>
              </div>
              <div className="text-xs text-slate-200">Software Product Lead • Bengaluru, Karnataka</div>
            </div>
          </div>
          <div className="mt-3 p-3 bg-rose-50/60 rounded-xl border border-rose-100 text-xs text-rose-900 flex items-center justify-between">
            <span className="font-semibold">Explainable AI: Both in Tech sector • High lifestyle alignment</span>
            <Link href="/how-it-works" className="text-brand-600 font-bold hover:underline">
              Details &rarr;
            </Link>
          </div>
        </div>
